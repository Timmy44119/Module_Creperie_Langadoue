...
public class ExtendedInvoiceGenerator extends InvoiceGenerator {
	private final Logger logger = LoggerFactory.getLogger(InvoiceGenerator.class);

	private final Invoice invoice;
	private final PriceListService priceListService;

	public ExtendedInvoiceGenerator(final Invoice invoiceParam, final PriceListService priceListServiceParam) {
